...
vignette: >
  %\VignetteIndexEntry{Meta-data description}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

These are brief description of the meta-data provided with the package and
stored in the 'extdata' folder of the package. Data can be read by using
the following command to read in the data.

```r
system.file(
  package = "FluxnetLSM",
  "extdata/Site_metadata.csv"
  )
```
...
df <- dplyr::as_tibble(
    ...
    system.file(
    package = "FluxnetLSM",
    "extdata/Output_variables_OzFlux.csv"
    ),
    header = TRUE,
    sep = ",",
    quote ="\"'"
